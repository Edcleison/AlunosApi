...
namespace AlunosApi.Controllers
{
    ...
    public class AlunosController : ControllerBase
    {
        ...
        public async Task<ActionResult<IAsyncEnumerable<AlunosService>>> GetAlunos()
        {
            try
            {
        ...
        public async Task<ActionResult<IAsyncEnumerable<AlunosService>>> GetAlunosByName([FromQuery] string nome)
        {
            try
            {
        ...
        public async Task<ActionResult<IAsyncEnumerable<AlunosService>>> GetAluno(int id)
        {
            try
            {
